...
# docker build -t ambu550/faketime-jdk19-alpine:0.3.3 .
# docker tag ambu550/faketime-jdk19-alpine:0.3.3 ambu550/faketime-jdk19-alpine:latest
# docker push ambu550/faketime-jdk19-alpine:0.3.3
