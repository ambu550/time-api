...
# docker build -t ambu550/faketime-jdk19-alpine:0.3.2 .
# docker tag ambu550/faketime-jdk19-alpine:0.3.2 ambu550/faketime-jdk19-alpine:latest
# docker push ambu550/faketime-jdk19-alpine:0.3.2
